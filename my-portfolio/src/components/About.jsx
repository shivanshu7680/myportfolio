...
function About() {
  return (
    <section
      id="about"
      className="p-10 md:p-20 text-center bg-gray-900/70 dark:bg-gray-800/70 backdrop-blur-md rounded-3xl mx-4 md:mx-20 my-10"
    >
      <motion.h2
        className="text-3xl md:text-4xl font-extrabold mb-6 text-white drop-shadow-lg"
      ...
      >
        ...
        with a strong interest in <span className="text-blue-400">Data Science, Machine Learning,</span> 
