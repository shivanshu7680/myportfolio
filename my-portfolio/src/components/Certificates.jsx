...
function Certificates() {
  ...
  return (
    <section id="certificates" className="p-10 md:p-20 bg-gray-900 text-white">
      <motion.h2
        className="text-3xl md:text-4xl font-bold mb-14 text-center text-blue-400"
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
        {certificates.map((cert, idx) => (
          ...
          >
            ...
            <h3 className="text-lg font-semibold mb-1 text-center text-white">
              {cert.title}
            </h3>
